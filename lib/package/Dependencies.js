...
function (_AbstractService) {
  ...
  (0, _createClass2["default"])(Dependencies, [{
    ...
    key: "copyProjectFile",
    value: function copyProjectFile(filename, destination) {
      var _this = this;
      ...
      return new Promise(function (resolve) {
        copyFile(filePath, path.join(_this.nodeJsDir, destination), function (copyErr) {
        ...
        return _regenerator["default"].wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 4:
                _context.next = 6;
                return this.copyProjectFile(this.plugin.settings.packagePath, 'package.json');
              ...
              case 6:
                ...
                _context.next = 9;
                return this.copyProjectFile(this.plugin.settings.packageLockPath || 'package-lock.json', 'package-lock.json');
              ...
              case 9:
                ...
                _context.next = 12;
                return this.copyProjectFile(this.plugin.settings.yarnLockPath || 'yarn.lock', 'yarn.lock');
